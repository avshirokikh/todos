    ...
    return (
        <div>
            <div className="task-list-item container p-3 my-3 border row  "
                ...
                <div
                    className={["task-list-item-title col-sm-12", overdue ? "overdue" : (status > 1 ? "complete" : "running")].join(' ')}> {title} </div>
                <div
                ...
                <div
                    className="task-list-item-status col-sm-4 ">Статус: {["к выполнению", "выполняется", "выполнена", "отменена"][status]} </div>
